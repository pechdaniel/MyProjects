...
begin
	...
	while @position < 4
	begin
		--selectam nr de linii pe care trebuie sa il inseram si id-ul tabelului corespunzator pozitiei
		...
		set @command = 'insertIntoTable '+ @tableName + ',' + convert(varchar(4),@noofrows)
	...
	begin
		...
		set @commanddel = 'deleteFromTable '+@tableName +','+ convert(varchar(5),@noofrows)
		exec (@commanddel)
		set @dateend = GETDATE()
