...
public class View {
    public static void main(String[] args) {
        ...
        IStmt expr4=new CompStmt(
                new OpenRFileStmt("var_f","C:\\Users\\pechd\\IdeaProjects\\lab8\\Example.txt"),new CompStmt(
        ...
        IStmt expr7 = new OpenRFileStmt("var_f","C:\\Users\\pechd\\IdeaProjects\\lab8\\Example.txt");
        ExeStack7.add(expr7);
...
//        IStmt st=new PrintStmt(new ConstExpr(7));
//        IStack<IStmt> e = new Stack<>();
//        IDictionary<String, Integer> s = new Dictionary<String, Integer>();
//        IList<Integer> o = new MyList<Integer>();
//        IDictionary<Integer, BufferedReader> f=new Dictionary<Integer, BufferedReader>();
//        IDictionary<Integer, Integer> h=new Dictionary<Integer, Integer>();
//        e.add(st);
//        ProgramState p=new ProgramState(e,s,o,f,h);
//        r.addPrg(p);
//        IRepo r1=((Repository) r).clone();
//        r1.addPrg(p);
...
//        Controller c=new Controller(r);
        ...
        menu.addCommand(new RunExample("8",expr8.toString(),ctrl8));
        menu.show();
    }
}
