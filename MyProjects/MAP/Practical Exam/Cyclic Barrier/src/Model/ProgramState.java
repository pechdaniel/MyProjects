...
public class ProgramState {
    ...
    private IDictionary<Integer,Pair> barrier;
    private Lock mylock;

    public ProgramState(IStack<IStmt> stack, IDictionary<String, Integer> symTable, IList<Integer> list, IDictionary<Integer, BufferedReader> file,IDictionary<Integer, Integer> h,IDictionary<Integer,Pair> b) {
        this.stack = stack;
    ...
    public IDictionary<Integer,Pair> getBarrier(){return barrier;}

    public void setBarrier(IDictionary<Integer,Pair> b){barrier=b;}
