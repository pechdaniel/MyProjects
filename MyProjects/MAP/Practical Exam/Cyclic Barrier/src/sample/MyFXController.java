...
public class MyFXController{
    ...
    @FXML
    private TableColumn<BarrierTableView,Integer> BarrierK;
    @FXML
    private TableColumn<BarrierTableView,Integer> BarrierN;
    @FXML
    private TableColumn<BarrierTableView,List<Integer>> BarrierL;
    ...
    public void setBarrier(){
        ObservableList<BarrierTableView> l=FXCollections.observableArrayList();
        for(Integer k:selectedState.getBarrier().getElements()){
            l.add(new BarrierTableView(k,selectedState.getBarrier().getValue(k).nr,selectedState.getBarrier().getValue(k).list));
        }
        this.BarrierTable.setItems(l);
    }
    ...
    public void initialize(){
        ...
        this.BarrierK.setCellValueFactory(new PropertyValueFactory<>("lk"));
        this.BarrierN.setCellValueFactory(new PropertyValueFactory<>("lv"));
        this.BarrierL.setCellValueFactory(new PropertyValueFactory<>("list"));
