...
import sample.TableViews.ProcTableView;
...
public class MyFXController{
    ...
    @FXML
    private TableView<ProcTableView> ProcTable;
    @FXML
    private TableColumn<ProcTableView,String> PK;
    @FXML
    private TableColumn<ProcTableView,List<String>> PP;
    @FXML
    private TableColumn<ProcTableView,String> PS;
    ...
    public void setSymTable(){
        ...
        for(String k:selectedState.getSyms().top().getElements()){
            l.add(new SymTableView(k,selectedState.getSyms().top().getValue(k)));
        }
    ...
    public void setProc(){
        ObservableList<ProcTableView> l=FXCollections.observableArrayList();
        for(String k:selectedState.getProc().getElements()){
            l.add(new ProcTableView(k,selectedState.getProc().getValue(k).list,selectedState.getProc().getValue(k).stmt.toString()));
        }
        this.ProcTable.setItems(l);
    }
    ...
    public void initialize(){
        ...
        this.PK.setCellValueFactory(new PropertyValueFactory<>("lk"));
        this.PP.setCellValueFactory(new PropertyValueFactory<>("list"));
        this.PS.setCellValueFactory(new PropertyValueFactory<>("lv"));

        IStack<IStmt> ExeStack1 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable1 = new Stack<>();
        IDictionary<String, Pair> proc1=new Dictionary<>();
        ...
        ExeStack1.add(expr1);
        ProgramState prgCurrent1 = new ProgramState(ExeStack1, SymTable1, out1,fileTable1,heap1,proc1);
        IRepo repo1 = new Repository();
        repo1.addPrg(prgCurrent1);
        Controller ctrl1 = new Controller(repo1);

        IStack<IStmt> ExeStack2 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable2 = new Stack<>();
        IDictionary<String, Pair> proc2=new Dictionary<>();
        ...
        ExeStack2.add(expr2);
        ProgramState prgCurrent2 = new ProgramState(ExeStack2, SymTable2, out2,fileTable2,heap2,proc2);
        IRepo repo2 = new Repository();
        repo2.addPrg(prgCurrent2);
        Controller ctrl2 = new Controller(repo2);

        IStack<IStmt> ExeStack3 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable3 = new Stack<>();
        IDictionary<String, Pair> proc3=new Dictionary<>();
        ...
        ExeStack3.add(expr3);
        ProgramState prgCurrent3 = new ProgramState(ExeStack3, SymTable3, out3,fileTable3,heap3,proc3);
        IRepo repo3 = new Repository();
        repo3.addPrg(prgCurrent3);
        Controller ctrl3 = new Controller(repo3);

        IStack<IStmt> ExeStack4 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable4 = new Stack<>();
        IDictionary<String, Pair> proc4=new Dictionary<>();
        ...
        ExeStack4.add(expr4);
        ProgramState prgCurrent4=new ProgramState(ExeStack4,SymTable4,out4,fileTable4,heap4,proc4);
        IRepo repo4=new Repository();
        repo4.addPrg(prgCurrent4);
        Controller ctrl4=new Controller(repo4);

        IStack<IStmt> ExeStack5 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable5 = new Stack<>();
        IDictionary<String, Pair> proc5=new Dictionary<>();
        ...
        ExeStack5.add(expr5);
        ProgramState prgCurrent5=new ProgramState(ExeStack5,SymTable5,out5,fileTable5,heap5,proc5);
        IRepo repo5=new Repository();
        repo5.addPrg(prgCurrent5);
        Controller ctrl5=new Controller(repo5);

        IStack<IStmt> ExeStack6 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable6 = new Stack<>();
        IDictionary<String, Pair> proc6=new Dictionary<>();
        ...
        ExeStack6.add(expr6);
        ProgramState prgCurrent6 = new ProgramState(ExeStack6, SymTable6, out6,fileTable6,heap6,proc6);
        IRepo repo6 = new Repository();
        repo6.addPrg(prgCurrent6);
        Controller ctrl6 = new Controller(repo6);

        IStack<IStmt> ExeStack7 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable7 = new Stack<>();
        IDictionary<String, Pair> proc7=new Dictionary<>();
        ...
        ExeStack7.add(expr7);
        ProgramState prgCurrent7 = new ProgramState(ExeStack7, SymTable7, out7,fileTable7,heap7,proc7);
        IRepo repo7 = new Repository();
        repo7.addPrg(prgCurrent7);
        Controller ctrl7 = new Controller(repo7);

        IStack<IStmt> ExeStack8 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable8 = new Stack<>();
        IDictionary<String, Pair> proc8=new Dictionary<>();
        ...
        ExeStack8.add(expr8);
        ProgramState prgCurrent8 = new ProgramState(ExeStack8, SymTable8, out8,fileTable8,heap8,proc8);
        IRepo repo8 = new Repository();
        repo8.addPrg(prgCurrent8);
        Controller ctrl8 = new Controller(repo8);

        IStack<IStmt> ExeStack9 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable9 = new Stack<>();
        IDictionary<String, Pair> proc9=new Dictionary<>();
        ...
        ExeStack9.add(expr9);
        ProgramState prgCurrent9 = new ProgramState(ExeStack9, SymTable9, out9,fileTable9,heap9,proc9);
        IRepo repo9 = new Repository();
        repo9.addPrg(prgCurrent9);
        Controller ctrl9 = new Controller(repo9);

        IStack<IStmt> ExeStack10 = new Stack<>();
        IStack<IDictionary<String, Integer>> SymTable10 = new Stack<>();
        IDictionary<String, Pair> proc10=new Dictionary<>();
        ...
        IStmt prc1=new Procedure("sum",new ArrayList<String>(Arrays.asList("a","b")),new CompStmt(new AssignStmt("v",new ArithmExpr("+",new VarExpr("a"),new VarExpr("b"))),new PrintStmt(new VarExpr("v"))));
        IStmt prc2=new Procedure("product",new ArrayList<String>(Arrays.asList("a","b")),new CompStmt(new AssignStmt("v",new ArithmExpr("*",new VarExpr("a"),new VarExpr("b"))),new PrintStmt(new VarExpr("v"))));
        IStmt a1=new CompStmt(new AssignStmt("v",new ConstExpr(2)),new CompStmt(new AssignStmt("w",new ConstExpr(5)),new CompStmt(new Call("sum",new ArrayList<IExpr>(Arrays.asList(new ArithmExpr("*",new VarExpr("v"),new ConstExpr(10)),new VarExpr("w")))),new CompStmt(new PrintStmt(new VarExpr("v")),new CompStmt(new forkStmt(new Call("product",new ArrayList<IExpr>(Arrays.asList(new VarExpr("v"),new VarExpr("w"))))),       new forkStmt(new Call("sum",new ArrayList<IExpr>(Arrays.asList(new VarExpr("v"),new VarExpr("w"))))))))));
        IStmt expr10=new CompStmt(prc1,new CompStmt(prc2,a1));
        ExeStack10.add(expr10);
        ProgramState prgCurrent10 = new ProgramState(ExeStack10, SymTable10, out10,fileTable10,heap10,proc10);
