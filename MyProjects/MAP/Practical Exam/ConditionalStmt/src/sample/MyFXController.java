...
public class MyFXController{
    ...
    public void initialize(){
        ...
        IStmt expr9 =new CompStmt(new AssignStmt("a",new ConstExpr(1)),new CompStmt(new AssignStmt("b",new ConstExpr(2)),new CompStmt(new CondAssignStmt("c",new VarExpr("a"),new ConstExpr(100),new ConstExpr(200)),new CompStmt(new PrintStmt(new VarExpr("c")),new CompStmt(new CondAssignStmt("c",new ArithmExpr("-",new VarExpr("b"),new ConstExpr(2)),new ConstExpr(100),new ConstExpr(200)),new PrintStmt(new VarExpr("c")))))));
        ExeStack9.add(expr9);
