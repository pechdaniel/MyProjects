...
public class ProgramState {
    ...
    public ProgramState(IStack<IStmt> stack, IDictionary<String, Integer> symTable, IList<Integer> list, IDictionary<Integer, BufferedReader> file,IDictionary<Integer, Integer> h,IDictionary<Integer,Integer> lo) {
        this.stack = stack;
    ...
    public void setLock(IDictionary<Integer,Integer> l){this.lock=l;}

    public IDictionary<Integer,Integer> getLock(){return this.lock;}
