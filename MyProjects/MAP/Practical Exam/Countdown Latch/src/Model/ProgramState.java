...
public class ProgramState {
    ...
    public ProgramState(IStack<IStmt> stack, IDictionary<String, Integer> symTable, IList<Integer> list, IDictionary<Integer, BufferedReader> file,IDictionary<Integer, Integer> h,IDictionary<Integer,Integer> l) {
        this.stack = stack;
    ...
    public IDictionary<Integer,Integer> getLatch(){return latch;}

    public void setLatch(IDictionary<Integer,Integer> l){latch=l;}
