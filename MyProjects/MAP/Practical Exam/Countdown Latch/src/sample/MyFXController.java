...
public class MyFXController{
    ...
    @FXML
    private TableView<LatchTableView> LatchTable;
    @FXML
    private TableColumn<LatchTableView,Integer> LatchK;
    @FXML
    private TableColumn<LatchTableView,Integer> LatchV;
    ...
    public void setLatch(){
        ObservableList<LatchTableView> l=FXCollections.observableArrayList();
        for(Integer k:selectedState.getLatch().getElements()){
            l.add(new LatchTableView(k,selectedState.getLatch().getValue(k)));
        }
        this.LatchTable.setItems(l);
    }
    ...
    public void initialize(){
        ...
        this.LatchK.setCellValueFactory(new PropertyValueFactory<>("lk"));
        this.LatchV.setCellValueFactory(new PropertyValueFactory<>("lv"));
        ...
        IDictionary<Integer, Integer> latch1=new Dictionary<>();
        IStmt expr1 = new CompStmt(new AssignStmt("v", new ConstExpr(2)),
                new PrintStmt(new VarExpr("v")));
        ExeStack1.add(expr1);
        ProgramState prgCurrent1 = new ProgramState(ExeStack1, SymTable1, out1,fileTable1,heap1,latch1);
        ...
        IDictionary<Integer, Integer> latch2=new Dictionary<>();
        ...
        ExeStack2.add(expr2);
        ProgramState prgCurrent2 = new ProgramState(ExeStack2, SymTable2, out2,fileTable2,heap2,latch2);
        ...
        IDictionary<Integer, Integer> latch3=new Dictionary<>();
        ...
        ExeStack3.add(expr3);
        ProgramState prgCurrent3 = new ProgramState(ExeStack3, SymTable3, out3,fileTable3,heap3,latch3);
        ...
        IDictionary<Integer, Integer> latch4=new Dictionary<>();
        ...
        ExeStack4.add(expr4);
        ProgramState prgCurrent4=new ProgramState(ExeStack4,SymTable4,out4,fileTable4,heap4,latch4);
        ...
        IDictionary<Integer, Integer> latch5=new Dictionary<>();
        ...
        ExeStack5.add(expr5);
        ProgramState prgCurrent5=new ProgramState(ExeStack5,SymTable5,out5,fileTable5,heap5,latch5);
        ...
        IDictionary<Integer, Integer> latch6=new Dictionary<>();
        ...
        ExeStack6.add(expr6);
        ProgramState prgCurrent6 = new ProgramState(ExeStack6, SymTable6, out6,fileTable6,heap6,latch6);
        ...
        IDictionary<Integer, Integer> latch7=new Dictionary<>();
        IStmt expr7 = new OpenRFileStmt("var_f","C:\\Users\\pechd\\IdeaProjects\\For Stmt\\Example.txt");
        ExeStack7.add(expr7);
        ProgramState prgCurrent7 = new ProgramState(ExeStack7, SymTable7, out7,fileTable7,heap7,latch7);
        ...
        IDictionary<Integer, Integer> latch8=new Dictionary<>();
        ...
        ExeStack8.add(expr8);
        ProgramState prgCurrent8 = new ProgramState(ExeStack8, SymTable8, out8,fileTable8,heap8,latch8);
        ...
        IDictionary<Integer, Integer> latch9=new Dictionary<>();
        ...
        ExeStack9.add(expr9);
        ProgramState prgCurrent9 = new ProgramState(ExeStack9, SymTable9, out9,fileTable9,heap9,latch9);
        ...
        IDictionary<Integer, Integer> latch10=new Dictionary<>();
        ...
        ProgramState prgCurrent10 = new ProgramState(ExeStack10, SymTable10, out10,fileTable10,heap10,latch10);
        ...
        IDictionary<Integer,Integer> latch11=new Dictionary<>();
        IStmt expr11=new CompStmt(new New("v1",new ConstExpr(2)),new CompStmt(new New("v2",new ConstExpr(3)),new CompStmt(new New("v3",new ConstExpr(4)),new CompStmt(new NewLatchStmt("cnt",new RH("v2")),new CompStmt(new forkStmt(new CompStmt(new WH("v1",new ArithmExpr("*",new RH("v1"),new ConstExpr(10))),new CompStmt(new PrintStmt(new RH("v1")),new CountdownStmt("cnt")))),                                    new CompStmt(new forkStmt(new CompStmt(new WH("v2",new ArithmExpr("*",new RH("v2"),new ConstExpr(10))),new CompStmt(new PrintStmt(new RH("v2")),new CountdownStmt("cnt")))),                                 new CompStmt(new forkStmt(new CompStmt(new WH("v3",new ArithmExpr("*",new RH("v3"),new ConstExpr(10))),new CompStmt(new PrintStmt(new RH("v3")),new CountdownStmt("cnt")))),                     new CompStmt(new AwaitStmt("cnt"),new CompStmt(new PrintStmt(new ConstExpr(100)),new CompStmt(new CountdownStmt("cnt"),new PrintStmt(new ConstExpr(100))))))))))));
        ExeStack11.add(expr11);
        ProgramState prgCurrent11 = new ProgramState(ExeStack11, SymTable11, out11,fileTable11,heap11,latch11);
