...
public class MyFXController{
    ...
    public void initialize(){
        ...
        IStmt expr4=new CompStmt(
                new OpenRFileStmt("var_f","C:\\Users\\pechd\\IdeaProjects\\Exam\\Switch\\Example.txt"),new CompStmt(
        ...
        IStmt expr7 = new OpenRFileStmt("var_f","C:\\Users\\pechd\\IdeaProjects\\Exam\\Switch\\Example.txt");
        ExeStack7.add(expr7);
        ...
        IStmt expr9 =new CompStmt(new AssignStmt("a",new ConstExpr(1)), new CompStmt(new AssignStmt("b",new ConstExpr(2)),new CompStmt(new AssignStmt("c",new ConstExpr(5)),new CompStmt(new SwitchStmt(new ArithmExpr("*",new VarExpr("a"),new ConstExpr(10)),new ArithmExpr("*",new VarExpr("b"),new VarExpr("c")),new CompStmt(new PrintStmt(new VarExpr("a")),new PrintStmt(new VarExpr("b"))),new ConstExpr(10),new CompStmt(new PrintStmt(new ConstExpr(100)),new PrintStmt(new ConstExpr(200))),new PrintStmt(new ConstExpr(100))),new PrintStmt(new ConstExpr(300))))));
        ExeStack9.add(expr9);
